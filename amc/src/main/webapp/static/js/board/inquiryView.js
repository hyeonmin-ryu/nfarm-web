...
Vue.component('maincontents', {
    ...
    methods:{
        ...
        // 답변 등록/수정
        reply: function() {
            location.href = "/board/inquiry/reply?inqryNo="+this.inqryNo;
        },
        // 답변삭제
        ...
        replyDelete: function() {
            post(TID.DELETE,
                "/board/inquiry/delete/"+this.replyInfo.inqryNo,
                {},
                this.callback);
        },
        // 수정
        ...
        mod: function() {
            location.href = "/board/inquiry/reg?inqryNo="+this.inqryNo;
        },
        // 삭제
        onclickDel: function () {
        ...
        del: function() {
            post(TID.DELETE,
                "/board/inquiry/delete/"+this.inqryNo,
                {},
                this.callback);
        },

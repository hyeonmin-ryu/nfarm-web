...
Vue.component('maincontents', {
    ...
    data: function() {
        return {
            ...
            messages : "",
            reqStoreStatCd : "",
            diseaseCdList : getCodeList('DISS_CD',this.callback),
            saveInfo: {
                bucketId : "",    // 저장소명
                othbcDataNm : "",   // 공개데이터명
                storgeReqstId : "",  // 저장신청Id
                dissRspnberUserId : ""
            }
        };
    },
    ...
    methods:{
        ...
        callbackPopupStorage : function(item){   // 저장소불러오기(팝업) Callback
            this.saveInfo.bucketId = item.storgeNm; // 저장소명
            this.saveInfo.storgeReqstId = item.storgeReqstId; //저장신청Id
        },
        // 신청정보 초기화 클릭
        onclickReset: function () {
            this.saveInfo.storgeReqstId = "";
            this.saveInfo.bucketId = "";
            this.saveInfo.othbcDataNm = "";
        },
        // 취소 클릭(목록 이동)
        ...
        saveReqStorage:function () {
            ...
            if(!this.saveInfo.storgeReqstId){
                alertMsg("저장소를 선택해주세요.");
                return false;
            }
            if(!this.saveInfo.othbcDataNm){
                alertMsg("공개데이터명은 필수입니다.",this.$refs.othbcDataNm);
                return false;
            }

...
Vue.component('maincontents', {
    ...
    data: function() {
        return {
            ...
            inquiryTypeList : getCodeList('INQRY_TYCD',this.callback), // 콤보박스 리스트
            maxFileCnt : 5,
            maxFileSize : 5,
        };
    },
    ...
    methods:{
        ...
        onclickCancel: function () {
            if(this.inqryNo) { // 수정중
                location.href = "/board/inquiry/view?inquirySeq="+this.inqryNo;
            } else { // 신규등록
        ...
        searchCallback: function (results) {
            if (results.success) {
                ...
                this.saveInfo.inqryTycd  = this.inquiry.inquiryTypeCode;
        ...
        saveCallback: function (results) {
            if (results.success) {
                ...
                if(frm.getAll("multipartFile").length > 0) {
                    this.inqryNo = results.response.inqryNo;
                    frm.append("inqryNo", this.inqryNo);

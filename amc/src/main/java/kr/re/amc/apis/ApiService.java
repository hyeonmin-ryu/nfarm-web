...
public class ApiService {
	...
	public final String apiServerHost = "https://ncloud.apigw.ntruss.com";
    ...
    **/
     ...
     *
    **/
    public static HttpHeaders getNcloudUserApiHeader(HttpMethod method, String url, String accessKey, String secretKey) {
        try {
     ...
     *
    **/
    public static  HttpHeaders getNcloudFileSaferApiHeader(HttpMethod method, String url, String accessKey, String secretKey) {
        try {
